...
WebMC 包含了一个完整的形状匹配合成系统。你可以通过 2x2 或 3x3 的矩阵来制造新的物品。

### 1. 基础合成 (2x2 随身合成)
按 **`E`** 打开背包，在界面右上角的 2x2 网格中摆放材料。
*   **木板 (Planks)**: 1x **原木 (Log)** -> 4x 木板
*   **木棍 (Sticks)**: 2x **木板** 垂直摆放 -> 4x 木棍
*   **工作台 (Crafting Table)**: 2x2 填满 **木板** -> 1x 工作台

### 2. 高级合成 (3x3 工作台)
在世界中放置 **工作台**，对其点击 **鼠标右键** 即可开启 3x3 合成界面。
*   **木镐 (Pickaxe)**: 顶部横向 3x **木板** + 中间一列 2x **木棍**
*   **木斧 (Axe)**: 侧边 L 型 3x **木板** + 2x **木棍**
*   **木锹 (Shovel)**: 1x **木板** + 下方 2x **木棍** 垂直摆放

*注：手持对应工具挖掘匹配的方块时，挖掘速度将提升 5 倍以上。*
...
- [x] **工具系统**：实现 3x3 矩阵合成、挖掘效率倍率与采收等级限制
